...
export default function Sidebar() {
  ...
  return (
    <div className="first" style={{ padding: "10px" }}>
      <Link
        to="/"
        className="logo"
        style={{ placeItems: "center", display: "grid", }}
      >
        <img style={{height:"70px",width:"auto"}} src="https://cdn.kibrispdr.org/data/105/download-logo-instagram-putih-png-42.png" />
      </Link>
      <div
        className="sections"
        style={{
